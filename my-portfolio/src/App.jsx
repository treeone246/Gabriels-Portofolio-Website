  ...
  const defaultData = {
    ...
    eyeAI: {
      ...
      shots: [
        ...
        { src: eyeAI2, label: 'Detection Result and Object Marking' },
        { src: eyeAI3, label: 'Vehicle Entry Analysis View' },
        { src: eyeAI4, label: 'Insight Panel and Metadata' },
        { src: eyeAI5, label: 'Interactive LLM Chat Flow' },
        { src: eyeAI6, label: 'Detection Explanation Context' },
